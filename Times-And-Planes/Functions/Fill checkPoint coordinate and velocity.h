...
#ifndef MAIN_CPP_FILL_CHECKPOINT_COORDINATE_AND_VELOCITY_H
#define MAIN_CPP_FILL_CHECKPOINT_COORDINATE_AND_VELOCITY_H
...
#endif //MAIN_CPP_FILL_CHECKPOINT_COORDINATE_AND_VELOCITY_H

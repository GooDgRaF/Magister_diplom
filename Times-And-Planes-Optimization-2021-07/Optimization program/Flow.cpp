...
void print_hull()
{
    cout << "Hull graph:" << endl;
    for (int i = 0; i < flow.hull.size(); ++i)
    {
        cout << flow.checkPoints[i].name << " --> ";
        for (auto el : flow.hull[i])
        {
            cout << flow.checkPoints[el].name << " ";
        }
        cout << endl;
    }
    cout << endl;
...
{
    cout << "Graph:" << endl;
    for (const auto &v : flow.graph)
    {
        cout << v.name << " -->";
        for (const auto &sonID : v.sons)
        {
            cout << " " << flow.graph.at(sonID).name;
        }
        cout << endl;
    }
    cout << endl;
